...
namespace SQU {
	namespace UI {
		...
		void SynthEmilionWidget::notifySynthEmilionMessage(std::shared_ptr<Comm::SynthEmilionMessage> message)
		{
		...
		void SynthEmilionWidget::dispatchSynthEmilionMessage(std::shared_ptr<Comm::SynthEmilionMessage> message)
		{
